...
exclude_patterns = ['_build', 'Thumbs.db', '.DS_Store', '../setup.py', '../tests*', '../modules*', './setup.py', './tests*', 'modules*', 'setup.py', 'tests*', 'modules*']
...
#sphinx-apidoc -o . .. ../se* ../test* ../modules*  -f --ext-viewcode -M