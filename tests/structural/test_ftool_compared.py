...
def compare(beam, name):
    ...
    assert shear_fconcrete == approx(shear_diagram_v47, abs=0.0001)
    assert momentum_fconcrete == approx(momentum_diagram_v47, abs=0.0001)
    assert rotation_diagram_v47 == approx(rotation_fconcrete, abs=0.0000000001)
    assert displacement_diagram_v47 == approx(displacement_fconcrete, abs=0.000001)
    #assert displacement_fconcrete == approx(displacement_diagram_v47, abs=0.01)
